...
namespace Utility {
    ...
    */
    ...
    /*
    * This is needed to be checked separately because according to the reffered article on this page:
    * https://en.wikipedia.org/wiki/Endianness#Floating-point_and_endianness
    * it can differ from integer representation.
    */
    bool isFloatLittleEndian()
    {
