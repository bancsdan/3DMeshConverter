...
class StlWriter final : public IWriter
{
    ...
    static constexpr unsigned int c_triangle_buffer_size_in_bytes = c_triangle_size_in_bytes*c_max_num_of_triangles_in_buffer;
...
public:
    void write(const std::string& file_name, const MeshData& mesh) const final override;
};
